  ...
  if (isLoading) {
    return (
      <section className="space-y-6">
        <PageHeader title="Quote Detail" subtitle="Loading quote information..." />
    ...
    return (
      <Card className="py-14 text-center">
        ...
        <p className="mt-2 text-sm text-slate-500">
          The quote may have been removed or is unavailable.
        </p>
      </Card>
    );
  }
  ...
  return (
    <section className="space-y-6">
      ...
      <PageHeader
        ...
        subtitle={`Received on ${formatDate(quote.createdAt)}`}
        ...
        <div className="space-y-6">
          <Card className="space-y-3">
            ...
            <div className="space-y-1 text-sm text-slate-700">
              ...
              <p>
                <span className="font-medium">Phone:</span> {quote.customerPhone}
              </p>
              <p>
                <span className="font-medium">City:</span> {quote.customerCity}
              </p>
            </div>
            {quote.notes ? (
          ...
          <Card className="space-y-4">
            ...
            <label className="block space-y-2">
              <span className="text-sm font-medium text-slate-700">Add Internal Note</span>
              <textarea
                ...
                placeholder="Write an internal update (optional)"
              />
            </label>
